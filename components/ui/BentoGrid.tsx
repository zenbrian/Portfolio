...
import {BackgroundGradientAnimation} from "./GradientBg"; // Adjust the import path as necessary
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: 'linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(119,119,119,0.8717612044817927) 35%, rgba(0,212,255,1) 100%)'
      }}
    >
